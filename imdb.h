...
class IMDB
{
	...
	// Provides functionality for comparing two movies and the actors in them.
	void actors_in_movies();

	// Provides functionality for displaying the coactors of a specific actor.
	void actors_and_coactors();
